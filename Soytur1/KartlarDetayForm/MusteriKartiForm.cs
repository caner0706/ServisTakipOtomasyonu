...
{
    public partial class MusteriKartiForm : Form
    {
        public MusteriKartiForm()
        {
            InitializeComponent();
        }
        ...
        {
            KartForm kartgeri6 = new KartForm();
            kartgeri6.Show();
            this.Hide();
        }
        ...
        private void MusteriKartiForm_MouseDown(object sender, MouseEventArgs e)
        {
            tutus = true;
        ...
        private void MusteriKartiForm_MouseMove(object sender, MouseEventArgs e)
        {
            if (tutus == true)
            {
        ...
        private void MusteriKartiForm_Load(object sender, EventArgs e)
        {
            DataTable dt = new DataTable();
            SqlDataAdapter da = new SqlDataAdapter("Select * From MüşteriKart", bgl.baglanti());
            da.Fill(dt);
        ...
        {
            MüşteriKayıt git = new MüşteriKayıt();
            git.Show();
            this.Hide();
        }

        private void MusteriKartiForm_MouseUp(object sender, MouseEventArgs e)
        {
            tutus = false;
            FareX = 0;
            FareY = 0;
