...
{
    public partial class MuhasebeYeniKayıt : Form
    {
        public MuhasebeYeniKayıt()
        {
            InitializeComponent();
        }
        ...
        {
            SqlCommand komut = new SqlCommand("insert into MerkezKasaKayıt(HesapAdı,Bakiye) values (@p1,@p2)", bgl.baglanti());
