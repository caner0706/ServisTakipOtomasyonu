...
{
    public partial class PazarlamaKartlariForm : Form
    {
        public PazarlamaKartlariForm()
        {
            InitializeComponent();
        }
        ...
        {
            KartForm kartgeri7 = new KartForm();
            kartgeri7.Show();
            this.Hide();
        }
        ...
        private void PazarlamaKartlariForm_MouseDown(object sender, MouseEventArgs e)
        {
            tutus = true;
        ...
        private void PazarlamaKartlariForm_MouseMove(object sender, MouseEventArgs e)
        {
            if (tutus == true)
            {
        ...
        {
            PazarlamaKartıYeniKayıt git = new PazarlamaKartıYeniKayıt();
            git.Show();
            this.Hide();
        }

        SqlBaglantisi bgl = new SqlBaglantisi();
        private void PazarlamaKartlariForm_Load(object sender, EventArgs e)
        {
            DataTable dt = new DataTable();
            SqlDataAdapter da = new SqlDataAdapter("Select * From Kayıt2", bgl.baglanti()); 
            da.Fill(dt);
            dataGridView1.DataSource = dt;
        }

        private void PazarlamaKartlariForm_MouseUp(object sender, MouseEventArgs e)
        {
            tutus = false;
            FareX = 0;
            FareY = 0;
