...
{
    public partial class GüzergahTanimlariForm : Form
    {
        public GüzergahTanimlariForm()
        {
            InitializeComponent();
        }
        ...
        {
            TanimlarForm geri4 = new TanimlarForm();
            geri4.Show();
            this.Hide();
        }
        ...
        private void GüzergahTanimlariForm_MouseDown(object sender, MouseEventArgs e)
        {
            tutus = true;
        ...
        private void GüzergahTanimlariForm_MouseMove(object sender, MouseEventArgs e)
        {
            if (tutus == true)
            {
        ...
        private void GüzergahTanimlariForm_Load(object sender, EventArgs e)
        {

        }

        private void GüzergahTanimlariForm_MouseUp(object sender, MouseEventArgs e)
        {
            tutus = false;
            FareX = 0;
            FareY = 0;
